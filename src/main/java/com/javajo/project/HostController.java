...
public class HostController {
	...
	public String listHouse(HttpServletRequest req) {
		...
		String path = "C:/Users/User/Desktop/java/study3/javajo_project/src/main/webapp/resources/upload_house_images";
		req.setAttribute("path", path);
		return "host/house_manage";
	}
			
	@RequestMapping(value ="/insertHouse.do", method=RequestMethod.GET)
