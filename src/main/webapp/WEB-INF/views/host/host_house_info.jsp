...
<section id="host_pdt_info" class="content">
	<div class="pdt_wrap">
		<div class="pdt_info">
            ...
            <div class="pdt_imgs">
            	<img class="pdt_img1" src="resources/upload_house_images/${getHouseByNum.house_image1}">
            	<img class="pdt_img2" src="resources/upload_house_images/${getHouseByNum.house_image2}">
            	<img class="pdt_img3" src="resources/upload_house_images/${getHouseByNum.house_image3}">
            	<img class="pdt_img4" src="resources/upload_house_images/${getHouseByNum.house_image4}">
            	<img class="pdt_img5" src="resources/upload_house_images/${getHouseByNum.house_image5}"> 
            </div>
			<div class="pdt_info-wrap">
				<div class="pdt_detail">
                	<div class="pdt_form">
                       	<div class="pdt_type">
                       		<img class="" src="resources/images/category/${getHouseByNum.house_type_image}">
                       		<p>${getHouseByNum.htype_des}</p>
                       	</div>
                       	<ul class="pdt_summary">
                        	<li><img src="resources/images/main/maxper.png"><span>${getHouseByNum.house_maxperson}명</span></li>
                            <li><img src="resources/images/main/room.png"><span>${getHouseByNum.house_room}개</span></li>
                            <li><img src="resources/images/main/bed.png"><span>${getHouseByNum.house_bed}개</span></li>
                            <li><img src="resources/images/main/bath.png"><span>${getHouseByNum.house_bath}개</span></li>
                       	</ul>
                 	</div>
                    <div class="pdt_theme-box">
                        ...
                        <ul class="pdt_theme">
						    ...
						    <li>
					            <img class="theme_img" src="resources/images/theme/${theme.htheme_image}"/>
			...
			<div class="pdt_fac">
                ...
                <ul class="fac_list">
				    ...
				    <li class="fac_item">
				        <img src="resources/images/amenities/${fac.hfac_image}" />
				        <p>${fac.hfac_des}</p>
				    </li>
                	</c:forEach>
                </ul>
	...
	<form id="deleteForm" action="hostQna_answer.do?mode=del" method="POST"
		...
		<input type="hidden" name="house_num" value="${getHouseByNum.house_num}" />
		 ...
		 <input type="hidden" id="hostqna_gcontent" name="hostqna_gcontent" value="">
		 <input type="hidden" id="hostqna_hcontent" name="hostqna_hcontent" value="">
	</form>
</section>
<!-- e: content -->
